  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="border-b border-white/10 pb-6">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Enhanced Style Analysis Example</h1>
      ...
      {/* Input Section */}
      <div className="bg-slate-50 dark:bg-slate-800/30 rounded-lg border border-white/10 p-6">
        <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Input Your Text</h2>
        
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-900 dark:text-white mb-2">Your Writing Style Sample</label>
            <textarea
              id="userSample"
              placeholder="Enter a sample of your writing style..."
              className="w-full h-32 bg-white dark:bg-slate-900 text-slate-900 dark:text-white rounded px-3 py-2 border border-white/10 focus:border-blue-500 resize-none"
              defaultValue="The quick brown fox jumps over the lazy dog. This is my writing style."
            />
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-900 dark:text-white mb-2">Text to Paraphrase</label>
            <textarea
              id="originalText"
          ...
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white font-medium py-2 px-4 rounded transition-colors"
          >
      ...
      {paraphraseResult && (
        <div className="space-y-6">
          {/* Paraphrase Results */}
          <div className="bg-slate-50 dark:bg-slate-800/30 rounded-lg border border-white/10 p-6">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Paraphrase Results</h2>
            
            <div className="grid grid-cols-2 gap-4">
              <div>
                <h3 className="text-sm font-medium text-slate-600 dark:text-slate-500 dark:text-slate-400 mb-2">Original</h3>
                <div className="bg-white dark:bg-slate-900 rounded p-3 text-slate-900 dark:text-white text-sm border border-white/5">
                  {paraphraseResult.originalText}
                </div>
              </div>
              <div>
                <h3 className="text-sm font-medium text-slate-600 dark:text-slate-500 dark:text-slate-400 mb-2">Paraphrased</h3>
                <div className="bg-white dark:bg-slate-900 rounded p-3 text-slate-900 dark:text-white text-sm border border-white/5">
          ...
          {comparison ? (
            ...
            <div className="bg-slate-50 dark:bg-slate-800/30 rounded-lg border border-white/10 p-12 text-center">
              <div className="inline-block">
                <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500"></div>
              </div>
              <p className="text-slate-600 dark:text-slate-500 dark:text-slate-400 mt-4">Analyzing style metrics...</p>
            </div>
          ) : null}
        </div>
      )}
      ...
      {/* Info Section */}
      <div className="bg-slate-50 dark:bg-slate-800/20 rounded-lg border border-white/10 p-6">
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-3">How This Works</h3>
        <ol className="space-y-2 text-sm text-slate-600 dark:text-slate-500 dark:text-slate-400">
          <li><strong className="text-slate-900 dark:text-white">Step 1:</strong> Enter your writing style sample (teaches the system your style)</li>
          <li><strong className="text-slate-900 dark:text-white">Step 2:</strong> Enter text to paraphrase</li>
          <li><strong className="text-slate-900 dark:text-white">Step 3:</strong> Click "Paraphrase & Analyze"</li>
          <li><strong className="text-slate-900 dark:text-white">Step 4:</strong> System paraphrases while maintaining your style</li>
          <li><strong className="text-slate-900 dark:text-white">Step 5:</strong> Structured metrics are analyzed and displayed</li>
          <li><strong className="text-slate-900 dark:text-white">Step 6:</strong> Enhanced panel shows 5 metric groups with alignment ratings</li>
        </ol>
