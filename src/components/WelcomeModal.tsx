  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className="relative glass-panel max-w-lg w-full p-6 lg:p-8 space-y-6 animate-scale-in shadow-2xl">
        ...
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 p-2 rounded-lg hover:bg-white/10 transition-colors text-slate-600 dark:text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200"
          aria-label="Close"
        >
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-slate-800 dark:text-slate-300">
            <p className="text-base lg:text-lg leading-relaxed">
              For the <span className="font-semibold text-brand-600 dark:text-brand-400">best accuracy</span> when creating your style profile, we recommend:
            </p>
            
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-brand-400 flex-shrink-0 mt-2"></div>
                <span><span className="font-semibold text-slate-900 dark:text-white">Use 0% AI content</span> — Your authentic writing style works best</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-brand-400 flex-shrink-0 mt-2"></div>
                <span><span className="font-semibold text-slate-900 dark:text-white">Submit your own words</span> — Original essays or writing samples</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-brand-400 flex-shrink-0 mt-2"></div>
                <span><span className="font-semibold text-slate-900 dark:text-white">Longer is better</span> — 200+ words give the AI more patterns to learn</span>
              </li>
            </ul>
