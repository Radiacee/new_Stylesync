  ...
  const ModalContent = () => (
    <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl z-50 flex items-center justify-center p-4">
      <div className="max-w-3xl w-full glass-panel p-8 space-y-6 max-h-[90vh] overflow-auto">
        ...
        {/* Toggle and Continue Button at Bottom */}
        <div className="pt-6 border-t border-white/10 space-y-6">
          {/* Toggle Section - Fixed at Bottom */}
          <div className="p-5 rounded-lg bg-gradient-to-r from-brand-500/10 to-purple-500/10 border border-brand-500/30">
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                disabled={saving}
                className={`relative inline-flex h-8 w-16 flex-shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-slate-900 ${
            ...
            <div className="mt-3 flex items-center gap-2 text-xs">
              ...
              <span className={consent ? 'text-brand-300 font-medium' : 'text-slate-400'}>
