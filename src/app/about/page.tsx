      ...
      <div className="max-w-4xl mx-auto">
        <div className="glass-panel p-8 lg:p-12 space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-brand-600 dark:text-brand-300">How It Works</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-brand-600 dark:text-brand-300">Responsible AI Use</h2>
              <div className="bg-slate-50 dark:bg-slate-800/50 border border-white/10 rounded-lg p-6 space-y-3">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-brand-600 dark:text-brand-300">Technology Stack</h2>
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <h3 className="font-medium text-slate-900 dark:text-white">Frontend</h3>
                  <ul className="space-y-1 text-slate-600 dark:text-slate-500 dark:text-slate-400">
                ...
                <div className="space-y-2">
                  <h3 className="font-medium text-slate-900 dark:text-white">AI & Backend</h3>
                  <ul className="space-y-1 text-slate-600 dark:text-slate-500 dark:text-slate-400">
